...
3. Вкладки. Гибко и быстро настраиваются (см. п. [Настроить команды в папке](#Настроить-команды-в-папке))
...
В этом окне можно выбрать папку источника, отключить ненужные вкладки и выбрать роль.
